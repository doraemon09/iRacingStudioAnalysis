...
def process_session_data(ibt_telemetry_data):
    try:
        ...
        weather_report = {
            ...
            'Wind': {
                'Direction': ibt_telemetry_data['WindDir'].iloc[0],
                'Velocity': ibt_telemetry_data['WindVel'].iloc[0],
            },
        }
        ...
        for lap in laps_best['LapNum'].values.tolist():
            ...
            charts_dict[lap] = {
                ...
                'LatAccel': chart_dataframe['LatAccel'].values.tolist(),
                'Yaw': chart_dataframe['Yaw'].values.tolist(),
